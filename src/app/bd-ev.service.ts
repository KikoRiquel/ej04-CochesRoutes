...
export class BdEvService {
  ...
  private modelos: any;
  private urlBase: string = 'http://localhost/search.php';
  private urlBaseExt: string =
  ...
  getVehiculos(): Array<any> {
    if (!this.vehiculos) {
      this.http.get(this.urlBaseExt + 'coches').subscribe((response: any) => {
        this.vehiculos = response;
      });
    }
  ...
  getFabricantes(): Array<any> {
    if (!this.fabricantes) {
      this.http
        .get(this.urlBaseExt + 'fabricantes')
  ...
  getTecnologias(): Array<any> {
    if (!this.tecnologias) {
      this.http
        .get(this.urlBaseExt + 'tecnologias')
        .subscribe((response: any) => {
  ...
  getModelos(): Array<any> {
    if (!this.modelos) {
      this.http.get(this.urlBaseExt + 'modelos').subscribe((response: any) => {
